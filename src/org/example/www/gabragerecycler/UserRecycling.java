...
public class UserRecycling implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * UserRecycling Namespace URI = http://www.example.org/gabrageRecycler/
	...
	protected org.example.www.gabragerecycler.User localUser;

	/**
	 * Auto generated getter method
	 * 
	 * @return org.example.www.gabragerecycler.User
	 */
	public org.example.www.gabragerecycler.User getUser() {
		return localUser;
	}
	 ...
	 * @param param User
	 */
	public void setUser(org.example.www.gabragerecycler.User param) {
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			java.lang.String namespacePrefix = registerPrefix(xmlWriter, "http://www.example.org/gabrageRecycler/");
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":UserRecycling", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "UserRecycling", xmlWriter);
			}
		...
		if (localPaperboard == java.lang.Integer.MIN_VALUE) {
			...
			xmlWriter
					.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localPaperboard));
		}
		...
		if (localTetrabriks == java.lang.Integer.MIN_VALUE) {
			...
			xmlWriter
					.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localTetrabriks));
		}
	...
	private static java.lang.String generatePrefix(java.lang.String namespace) {
		if (namespace.equals("http://www.example.org/gabrageRecycler/")) {
			return "ns1";
		}
	...
	public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
		...
		elementList.add(new javax.xml.namespace.QName("", "bottles"));

		elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localBottles));

		elementList.add(new javax.xml.namespace.QName("", "paperboard"));

		elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localPaperboard));

		elementList.add(new javax.xml.namespace.QName("", "glass"));

		elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localGlass));

		elementList.add(new javax.xml.namespace.QName("", "tetrabriks"));

		elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localTetrabriks));

		elementList.add(new javax.xml.namespace.QName("", "cans"));

		elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCans));
	...
	public static class Factory {
		...
		public static UserRecycling parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			UserRecycling object = new UserRecycling();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"UserRecycling".equals(type)) {
							...
							return (UserRecycling) org.example.www.gabragerecycler.ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("", "user").equals(reader.getName())) {
					...
					object.setUser(org.example.www.gabragerecycler.User.Factory.parse(reader));
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("", "bottles").equals(reader.getName())) {
					...
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						throw new org.apache.axis2.databinding.ADBException(
								"The element: " + "bottles" + "  cannot be null");
					}

					java.lang.String content = reader.getElementText();

					object.setBottles(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(content));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("", "paperboard").equals(reader.getName())) {

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						throw new org.apache.axis2.databinding.ADBException(
								"The element: " + "paperboard" + "  cannot be null");
					}

					java.lang.String content = reader.getElementText();

					object.setPaperboard(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(content));
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("", "glass").equals(reader.getName())) {
					...
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						throw new org.apache.axis2.databinding.ADBException(
								"The element: " + "glass" + "  cannot be null");
					}

					java.lang.String content = reader.getElementText();

					object.setGlass(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(content));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("", "tetrabriks").equals(reader.getName())) {

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						throw new org.apache.axis2.databinding.ADBException(
								"The element: " + "tetrabriks" + "  cannot be null");
					}

					java.lang.String content = reader.getElementText();

					object.setTetrabriks(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(content));
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("", "cans").equals(reader.getName())) {
					...
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						throw new org.apache.axis2.databinding.ADBException(
								"The element: " + "cans" + "  cannot be null");
					}

					java.lang.String content = reader.getElementText();

					object.setCans(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(content));
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("", "date").equals(reader.getName())) {
					...
					object.setDate(org.apache.axis2.databinding.utils.ConverterUtil.convertToDate(content));
